  ...
  >
    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
      <div className="flex items-center justify-between flex-wrap gap-5">
        ...
        <button type="button" className="flex items-center h-fit py-4 px-6 bg-gradient-to-r from-green-400 via-purple-500 to-blue-500 hover:from-red-500 to-purple-900 rounded-[32px] gap-[12px]">
          <img
            src="/headset.svg"
            alt="headset"
